...
(() => {
    ...
    //カーソルの設定
    wd_front_rect_width = 236;
    wd_front_rect_height = 36;
    wd_front_rect_spacing = 8;
    ...
    wd_front_nameview_x = 4;
    wd_front_nameview_y = 0;
    wd_front_nameview_width = 152;
    ...
    wd_front_lvview_x = 164;
    wd_front_lvview_y = 0;
    wd_front_lvview_width = 64;
    ...
    wd_back_nameview_x = 4;
    wd_back_nameview_y = 0;
    wd_back_nameview_width = 152;
    ...
    //レベルの表示
    wd_back_lvview = true;
    wd_back_lvview_x = 164;
    wd_back_lvview_y = 0;
    wd_back_lvview_width = 64;
